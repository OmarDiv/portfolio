              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-4">
                  <img 
                    ...
                    alt="Omar Mohamed Omar - Full Stack Developer"
                    className="w-72 h-72 rounded-full object-cover object-center shadow-elegant border-4 border-background hover:scale-105 transition-transform duration-300 bg-background"
                    loading="eager"
                    onError={(e) => {
